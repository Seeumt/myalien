...
def pre_prepare():
    ...
    cheers_btn = Button(game_setting, screen, "CHEERS", 100, 40,
                        ...
                        "images/cheers0.png")
    return game_setting, gift_sound, shot_sound, collision_sound, screen, ship, bullets, aliens, alien_bullets_1, gifts, stats, play_btn, start_btn, help_btn, exit_btn, dest_btn, cheers_btn
...
def game1():
    ...
    while True:
        ...
        if stats.game_active:
            ...
            # screen.blit(pygame.image.load("images/life.jpeg"),life_rect)
